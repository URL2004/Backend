...
function academicReportBlock(register) {
  return [
    ...
    '“뜬금없는 결합”처럼 학술 서술에 남은 구어 표현과 “폭발적인 반응”처럼 과장된 수식은 직접 인용·정식 구성개념이 아닐 때만 중립적인 학술 표현으로 고친다. 반응의 강도와 불일치 정도는 낮추지 말고, 이론 용어를 추정해 다른 개념으로 바꾸지 않는다.',
    '연구 목적 한 문장에 목적·핵심 단서·작동 과정·검증 조건이 겹치면 논리 역할을 따라 두세 문장으로 나눈다. 변수명, 따옴표 속 구성개념, 상향·하향 같은 조건과 인과 방향은 그대로 유지한다.',
