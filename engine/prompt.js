...
function buildSystemPrompt(mode = 'assignment', lang = 'ko', { speakerType = 'individual', lengthPolicy, userNotes = '', register = 'mixed', evidence = '', anchorIdx = null, tonePolish = false, styleProfile = '' } = {}) {
  ...
  const plainServiceBlogKo = basicBlogStyle
    ? '· ★업체 블로그 표현 선택: 현장감은 살리되 문학적·감성적 표현, 과장된 결과 단정, 구어적 작업 동사는 쓰지 마라. 현장 후기 도입은 현재형보다 과거형("작업이었습니다")이 자연스럽다. 먼지·오염은 "조용히/묵묵히 쌓입니다"가 아니라 "쉽게/계속 쌓입니다"처럼 설명하고, 청결감·사용감은 감성적으로 돌려 말하지 말고 "오래 유지되기 어렵습니다 / 깨끗한 상태로 마무리되었습니다"처럼 직접 쓴다. 작업 동사는 "빨아들였습니다"보다 "흡입했습니다", 냄새 표현은 "잡아냈습니다/잡는 방향"보다 "냄새 관리에 중점을 두고 작업했습니다", 위치 표현은 "언저리"보다 "주변"이 맞다. 결과도 과장하지 말고 "정리되었습니다/관리했습니다/마무리되었습니다"처럼 담백하게 쓴다.'
    : '';
