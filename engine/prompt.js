...
function buildSystemPrompt(mode = 'assignment', lang = 'ko', { speakerType = 'individual', lengthPolicy, userNotes = '', register = 'mixed', evidence = '', anchorIdx = null, tonePolish = false, styleProfile = '' } = {}) {
  ...
  const plainServiceBlogKo = basicBlogStyle
    ? '· ★업체 블로그 표현 선택: 현장감은 살리되 문학적·감성적 표현은 쓰지 마라. 현장 후기 도입은 현재형보다 과거형("작업이었습니다")이 자연스럽다. "먼지가 조용히 쌓입니다"보다 "먼지가 쉽게 쌓입니다", "청결감이 오래 버티지 못합니다/금방 흐려지고 맙니다"보다 "청결감이 오래 유지되기 어렵습니다", "빨아들였습니다"보다 "흡입했습니다", "냄새를 잡아냈습니다/집중적으로 잡는 방향"보다 "냄새 관리에 중점을 두고 작업했습니다", "배수구 언저리"보다 "배수구 주변", "눌어붙은 먼지"보다 "쌓인 먼지", "사용감이 옅어졌습니다"보다 "깨끗한 상태로 마무리되었습니다"가 맞다. 결과도 과장하지 말고 "정리되었습니다/관리했습니다/마무리되었습니다"처럼 담백하게 쓴다.'
    : '';
