...
module.exports = [
  ...
  // ── 반복: 완전중복(결론 두 번) · 근접중복(어미만 다른 결론) · 병렬구조 오탐 금지 ──
  {
    name: 'rep/완전중복 결론 두 번',
    mode: 'blog',
    input: '실내 습도 관리법을 정리한다.',
    output: '환기를 자주 하세요. 결론적으로 실내 습도는 사십에서 육십 퍼센트로 유지하는 게 가장 좋습니다. 그리고 제습기도 쓰면 좋아요. 결론적으로 실내 습도는 사십에서 육십 퍼센트로 유지하는 게 가장 좋습니다.',
    expect: { repFlagged: true }
  },
  {
    name: 'rep/근접중복(어미·단어만 다른 결론)',
    mode: 'blog',
    input: '실내 습도 관리법을 정리한다.',
    output: '결론적으로 실내 습도는 사십에서 육십 퍼센트로 유지하는 것이 가장 좋습니다. 따라서 제습 환기를 신경 쓰세요. 결론적으로 실내 습도는 사십에서 육십 퍼센트로 유지하는 것이 제일 좋습니다.',
    expect: { repFuzzy: true, repFlagged: true }
  },
  {
    name: 'rep/병렬구조는 반복 아님 — 오탐 금지',
    mode: 'blog',
    input: '습도 관리 팁을 정리한다.',
    output: '첫째로 환기를 자주 하면 곰팡이를 막을 수 있습니다. 둘째로 제습기를 쓰면 장마철 습도를 잡을 수 있습니다.',
    expect: { repFlagged: false }
  },
