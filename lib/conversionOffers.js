...
const CREDIT_PRODUCT_BASES = Object.freeze({
  2900: Object.freeze({ amount: 2900, baseCredits: 100, label: '스타터', purchasable: true, legacy: true }),
  5900: Object.freeze({ amount: 5900, baseCredits: 200, label: '스타터', purchasable: true }),
  8700: Object.freeze({ amount: 8700, baseCredits: 300, label: '라이트', purchasable: true, legacy: true }),
...
const ENTRY_PRODUCT_AMOUNT = 2900; // ROLLBACK 2026-09-04
...
const CREDIT_OFFER_POLICY_VERSION = 'credit-offer-v4-202609-rollback';
