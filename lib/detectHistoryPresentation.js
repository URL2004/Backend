...
const KEYS = new Set(['version', 'score', 'status', 'band', 'subBand', 'label', 'headline', 'description', 'evidence', 'pattern', 'nextSteps', 'limitations', 'sample', 'assessability']);
...
function boundedInterpretation(value, score) {
  if (!value || typeof value !== 'object' || Array.isArray(value)
      || !['detect-interpretation-v1', 'detect-interpretation-v2', VERSION].includes(value.version) || value.score !== normalizeScore(score)
