...
const BANDS = Object.freeze({
  ...
  low: Object.freeze({
    ...
    detail(probability) {
      return `AI식 문체 점수 ${probability}/100은 낮은 구간입니다. 정돈된 문장이나 반복 표현이 일부 보여도 글 전체의 AI식 문체 신호는 낮게 해석해야 합니다.`;
    }
  }),
  moderate: Object.freeze({
    ...
    detail(probability) {
      return `AI식 문체 점수 ${probability}/100은 중간 구간입니다. 일부 정형적인 특징이 보이지만, 이 점수만으로 작성 주체를 판단할 수는 없습니다.`;
    }
  }),
  high: Object.freeze({
    level: 'high',
    ...
    detail(probability) {
      return `AI식 문체 점수 ${probability}/100은 높은 구간입니다. 아래 특징이 글 전반에서 반복되어 점수를 높인 신호로 관찰됐습니다.`;
    }
  })
});
