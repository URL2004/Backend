...
function buildDetectReportView({
  ...
  const verifiedStatisticalSupport = require('./detectStatisticalAssist').sanitizeSupport(statisticalSupport);
...
function buildSentenceMap(paras, detail, { sourceParagraphs = paras } = {}) {
