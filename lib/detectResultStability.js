...
function variantForConfig(config = {}, options = {}) {
  const payload = {
    ...
    consistencyVersion: require('./detectConsistency').VERSION,
    consistencyEnabled: require('./detectConsistency').enabled(),
    evidenceCriteriaEnabled: require('./detectConsistency').criteriaEnabled(),
