...
const VERSION = 'detect-result-stability-v2';
...
function cleanResult(value) {
  ...
  return {
    ...
    ...(Number.isFinite(Number(value.modelProbability)) ? {
    ...
    ...(value.signalContractVersion === 'model-signals-v1' ? { signalContractVersion: 'model-signals-v1' } : {}),
