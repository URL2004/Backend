...
const VERSION = 'statistical-assist-v3-monotone';
...
function sanitizeSupport(value) {
  ...
  if (!value || ![VERSION, 'statistical-assist-v2', 'statistical-assist-v1'].includes(value.version) || value.applied !== true
    ...
    || value.score < 50 || value.score > 74 || value.score <= value.originalScore
