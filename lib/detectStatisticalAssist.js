...
const VERSION = 'statistical-assist-v5-whitespace-stable';
...
function sanitizeSupport(value) {
  ...
  const modern = [VERSION, 'statistical-assist-v4-evidence-bounded'].includes(value?.version);
  if (!value || ![VERSION, 'statistical-assist-v4-evidence-bounded', 'statistical-assist-v3-monotone', 'statistical-assist-v2', 'statistical-assist-v1'].includes(value.version) || value.applied !== true
