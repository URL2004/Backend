...
const CURRENT_BILLING_DISPOSITIONS = new Set(['charged', 'plan_unlimited', 'admin_no_charge']);
...
const NUMBER_FIELDS = Object.freeze([
  'schemaVersion', 'profileConfidence', 'detectedProfileConfidence', 'profileMargin',
  'repairCount', 'chunkCount', 'logicalChunkCount', 'editableChunkCount', 'lockedChunkCount',
  'skippedChunkCount', 'transformedChunkCount', 'approvedModelChunkCount', 'modelFailureChunkCount',
  ...
  'humanizationTargetCoverage', 'structuralChangedSentenceCount', 'structuralChangedSentenceRatio',
  ...
  'resumeRepetitionAchievedReduction', 'resumeRepetitionCoverage', 'sectionRecoveryAttemptCount',
  'sectionRecoveryAppliedCount', 'sectionRecoveryEscalationCount', 'sectionRecoveryRejectedAttemptCount',
  'sectionRecoveryMiniAppliedCount', 'sectionRecoveryEscalationAppliedCount',
  'fingerprintIntroducedCount', 'fingerprintRepairCount', 'fingerprintShadowPositiveCount',
  ...
  'koreanDeterministicRepairCount', 'koreanRefinementRetryCount', 'formalRegisterResidualCount',
  'quoteContentChangedCount', 'quoteIntegrityRestoreCount', 'sourceArtifactRemovedCount',
  'sourcePreflightNoticeCount', 'sectionPathErrorCount', 'chunkConcurrency',
...
const BOOLEAN_FIELDS = Object.freeze([
  ...
  'resumeRepetitionApplicable', 'resumeRepetitionPass', 'endingStylePass',
...
const ARRAY_FIELDS = Object.freeze([
  ...
  'effectNoticeCodes', 'legalIntegrityIssueCodes'
]);
...
function compactHistoryEngineMeta(meta = {}) {
  ...
  compact.humanizationDepthRetryRejectionCodes = compact.humanizationDepthRetryRejectionCodes
    .filter(value => ['candidate_unchanged', 'safety_audit_failed', 'depth_not_improved', 'retry_error'].includes(value));
