...
function publicRecentRow(row) {
  const fields = [
    ...
    'humanizationDepthApplicable', 'humanizationDepthPass',
    ...
    'fingerprintRepairCount', 'fingerprintShadowPositiveCount', 'endingStylePass', 'endingStyleIssueCount',
    ...
    'koreanRefinementPass', 'formalRegisterResidualCount', 'quoteIntegrityPass', 'quoteCountChanged', 'quoteContentChangedCount',
