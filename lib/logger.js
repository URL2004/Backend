...
const SENSITIVE_KEY_RE = /(^|_|\b)(authorization|cookie|password|secret|idtoken|accesstoken|access_token|refreshtoken|refresh_token|customtoken|paymentkey|billingkey|authkey|customerkey|cardnumber|email|phone)(_|$|\b)/i;
