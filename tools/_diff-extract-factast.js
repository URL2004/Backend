...
function withFlag(v, fn) { const o = process.env.FACT_AST; if (v) process.env.FACT_AST = '1'; else delete process.env.FACT_AST; try { return fn(); } finally { if (o === undefined) delete process.env.FACT_AST; else process.env.FACT_AST = o; } }
