...
> **역사 설계 문서(운영 계약 아님, 2026-07-25).** 아래의 Anthropic·`engine/evidence.js`
> 경로는 폐기됐다. 현재 운영은 OpenAI Responses API 단일 경로이며, 사용자 승인 근거는
> `routes/transform.js`와 `engine/evidencereview.js`를 거쳐 원문과 함께 감사한다.
